...
export type RawValuePoint = z.infer<typeof schemas.RawValuePoint>;
export type RawValuesResponse = z.infer<typeof schemas.RawValuesResponse>;
export type RawValuesMapResponse = Record<string, RawValuesResponse>;
