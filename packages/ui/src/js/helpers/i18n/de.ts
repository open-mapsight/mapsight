...
const de: Record<string, string> = {
	...
	"ui.place-actions.nav": "Aktionen zum Ort",
	"ui.place-actions.share": "Teilen",
	"ui.place-actions.share.tooltip": "Diesen Ort teilen",
	"ui.place-actions.share.dialog": "Link teilen",
	"ui.place-actions.share.copy": "Link kopieren",
	"ui.place-actions.share.copied": "Kopiert",
	"ui.place-actions.share.close": "Teilen-Dialog schließen",
	"ui.place-actions.share.permalink": "Permalink",
	"ui.place-actions.navigate": "Route",
	"ui.place-actions.navigate.tooltip":
		"Zu diesem Ort mit einer anderen App navigieren",
	"ui.place-actions.navigate.menu": "Navigation wählen",
	"ui.place-actions.navigate.geo": "Geräte-Karten-App",
	"ui.place-actions.navigate.google": "Google Maps",
	...
	"ui.place-actions.call.tooltip": "Diesen Ort anrufen",
	...
	"ui.feature-list.distance.fromGeolocation":
