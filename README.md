...
| <nobr>📈 [**`count-aggregator-ui`**](packages/count-aggregator-ui/README.md)</nobr><br>![NPM Version](https://img.shields.io/npm/v/%40mapsight%2Fcount-aggregator-ui?style=flat)       | **Count aggregator UI (React)**<br>Embeddable wizard, time-series charts, and export links for count-aggregator applications.                                                                                                                                                                                                                                           |
